...
class LmsOutageEnabled extends Mailable
{
    ...
    /**
     * @return LmsOutageEnabled
     */
    public function build()
    {
        return $this->view('emails.lms_outage_enabled')
            ->subject('Your LMS Connection Has Been Restored for ' . $this->course_name)
            ->with(array_merge(
